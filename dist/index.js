import React, { createContext, memo, useCallback, useContext, useEffect, useImperativeHandle, useLayoutEffect, useMemo, useReducer, useRef, useState } from "react";
...
function useInterval() {
	...
	return [useCallback((listener, duration) => {
...
function useNodeRef(onChange) {
	...
	return [node, useCallback((element) => {
...
function useSensors() {
	...
	return useMemo(() => [...sensors].filter((sensor) => sensor != null), [...sensors]);
}
...
function useDragOverlayMeasuring(_ref) {
	let { measure } = _ref;
	const [rect, setRect] = useState(null);
	const resizeObserver = useResizeObserver({ callback: useCallback((entries) => {
	...
	const [nodeRef, setRef] = useNodeRef(useCallback((element) => {
...
var InternalContext = /*#__PURE__*/ createContext({
	activatorEvent: null,
	activators: [],
	active: null,
	activeNodeRect: null,
...
var DndContext = /*#__PURE__*/ memo(function DndContext(_ref) {
	...
	const [state, dispatch] = useReducer(reducer, void 0, getInitialState);
	...
	const activators = useCombineActivators(sensors, useCallback((handler, sensor) => {
		return (event, active) => {
	...
	return React.createElement(DndMonitorContext.Provider, { value: registerMonitorListener }, React.createElement(InternalContext.Provider, { value: internalContext }, React.createElement(PublicContext.Provider, { value: publicContext }, React.createElement(ActiveDraggableContext.Provider, { value: transform }, children)), React.createElement(RestoreFocus, { disabled: (accessibility == null ? void 0 : accessibility.restoreFocus) === false })), React.createElement(Accessibility, {
		...accessibility,
...
function useDroppable(_ref) {
	...
	const [nodeRef, setNodeRef] = useNodeRef(useCallback((newElement, previousElement) => {
...
function DroppableZone({ id, x, y, isOccupied = false, showResults = false, isCorrect = false, onClick, isTarget = false }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!isOccupied && !showResults && /* @__PURE__ */ jsx("span", {
			style: {
				fontSize: "1.4rem",
			...
			children: isTarget ? "📍" : "🎯"
		}), isOccupied && /* @__PURE__ */ jsx("div", { style: {
			width: "22px",
			height: "22px",
...
function DraggableItem({ id, name, disabled = false, isSelected = false, onSelect }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		...disabled ? {} : listeners,
		...attributes,
		children: [/* @__PURE__ */ jsx("span", { children: isSelected ? "👉" : "⠿" }), /* @__PURE__ */ jsx("span", { children: name })]
	});
}
//#endregion
	...
	return /* @__PURE__ */ jsxs(DndContext, {
      ...
      ` }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [Object.keys(placements).length > 0 && /* @__PURE__ */ jsxs("div", {
					style: {
						width: "100%",
						display: "flex",
						justifyContent: "space-between",
					...
					children: [
						...
						slide.originalZones.map((zone) => {
							...
							return /* @__PURE__ */ jsx(DroppableZone, {
								id: String(zone.id),
								x,
								y,
								isOccupied,
							...
							return /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										!isExpanded && requireDefs && /* @__PURE__ */ jsx("span", {
											style: {
									...
									children: [requireDefs && /* @__PURE__ */ jsxs("div", {
										style: {
											display: "flex",
											flexDirection: "column",
											gap: "0.25rem",
										...
										children: [/* @__PURE__ */ jsx("label", {
											...
											}), showResults && /* @__PURE__ */ jsx("span", { children: defCorrect ? "✅" : "❌" })]
										})]
									}), !showResults && /* @__PURE__ */ jsxs("button", {
										onClick: (e) => {
											e.stopPropagation();
											const np = { ...placements };
											delete np[zoneId];
										...
										children: [/* @__PURE__ */ jsx("span", { children: "🗑️" }), " Quitar de la zona"]
									})]
								})]
							}, `placed-${zoneId}`);
						})
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							!showResults && availableItems.length > 0 && /* @__PURE__ */ jsxs("div", {
								style: {
									fontSize: "0.82rem",
								...
								}), /* @__PURE__ */ jsx("span", { children: selectedItemId ? "Toca el círculo en la imagen donde quieras colocarlo" : "Arrastra el elemento a la imagen o tócalo para seleccionarlo" })]
							}),
							/* @__PURE__ */ jsxs("div", {
								style: {
									display: "flex",
								...
								children: [availableItems.map((item) => /* @__PURE__ */ jsx(DraggableItem, {
									id: String(item.id),
									name: item.item_name,
									disabled: showResults,
									isSelected: selectedItemId === String(item.id),
									onSelect: handleSelectItem
								}, item.id)), availableItems.length === 0 && /* @__PURE__ */ jsx("p", {
									style: {
										color: "var(--magrana-text-muted, #A1A1AA)",
										fontSize: "0.875rem"
									},
					...
					requireDefs && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h3", {
							...
							children: slide.definitions.map((def) => /* @__PURE__ */ jsxs("li", {
								style: {
...
React.forwardRef(function(_a, ref) {
	...
	if (!visible) return placeholder ? jsx(Fragment, { children: placeholder }) : null;
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: mode === "zoom" ? /* @__PURE__ */ jsx(TransformWrapper, {
					minScale: 1,
					maxScale: 6,
...
//#endregion
export { AppSettingsModal, Badge, Button, Card, DragDropActivity, DraggableItem, DroppableZone, HeatmapActivity, ProfileView, SidebarProfileButton, isPinCorrect, resolveImageUrl, shuffleArray };
